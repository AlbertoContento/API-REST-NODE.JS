...
const tickets = [
    { user: users[0]._id, title: 'Ticket 1', price: 20 }, // Usando UUIDs como strings
    { user: users[1]._id, title: 'Ticket 2', price: 30 },
];
...
async function createTickets() {
    ...
    for (let i = 0; i < 15; i++) {
        ...
        title: `Ticket #${i}`,
        deleteCollectionsscription: `This is a description for Ticket #${i}`,
